...
define('SERVAL_THEME_URL','https://wwwows.com/product/serval-wordpress-theme/');
define('SERVAL_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('SERVAL_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'serval_admin_theme_page_more_features' ) ) {
	function serval_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Serval Premium', 'serval' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'serval' ); ?></p>
    <a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Serval Premium', 'serval' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'serval_admin_theme_page_title' ) ) {
	function serval_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Serval WordPress Theme', 'serval' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Serval! Check all the theme features.', 'serval' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'serval' );?></h2>
</div>
<?php
	}
}    
 
// Serval admin page content   
if ( ! function_exists( 'serval_admin_theme_page' ) ) {
	function serval_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php serval_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Serval features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'serval' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'serval' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'serval' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'serval' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SERVAL_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'serval' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Serval features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'serval' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Serval premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'serval' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'serval' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php serval_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'serval' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'serval' ); ?></p>
        <a href="<?php echo esc_url(SERVAL_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'serval' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'serval' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'serval' ); ?></p>
        <a href="<?php echo esc_url(SERVAL_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'serval' ); ?></a>
    </div>
</div>
<?php
	}
